        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="bg-surface rounded-xl p-4">
            ...
            <p className="text-secondary">
              Remember: the destination is always the <b>car at the end of the trip</b>, not the summit. Weather changes, fatigue, and conditions may require turning back—and that's the right call.
            </p>
          </div>
